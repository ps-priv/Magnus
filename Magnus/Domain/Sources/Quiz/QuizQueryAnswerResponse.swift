...
public struct QuizQueryAnswerResponse : Hashable, Decodable, Encodable {
    ...
    public let status: QuizQueryStatusEnum
    public let answers: [QuizAnswer]?    
    //public let user_answers: [QuizUserAnswer]

    public init(query_id: String, query_no: Int, query_type: QuizQueryTypeEnum, query_text: String, query_time: String?, status: QuizQueryStatusEnum, answers: [QuizAnswer]?) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        do {
            ...
            status = try container.decode(QuizQueryStatusEnum.self, forKey: .status)
    ...
    private enum CodingKeys: String, CodingKey {
        case query_id, query_no, query_type, query_text, query_time, status, answers
    }
}