public struct News: Identifiable, Hashable, Decodable {
    ...
    public init(id: String, publish_date: String, title: String, description: String, author: Author, read_count: Int, reactions_count: Int, comments_count: Int, image: String, tags: String, is_bookmarked: Bool) {
        self.id = id
