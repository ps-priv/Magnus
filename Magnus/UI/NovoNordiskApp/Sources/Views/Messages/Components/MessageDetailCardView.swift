...
#Preview("MessageDetailCardView") {
   let message = ConferenceMessageDetails(
     id: "eyJpZCI6MSwidG9rZW4iOiIxOHxQSDh3QThDdjZqcTNvbTVKUGo0YnNLcmhrUmZHVmdDQ0pTdDRCZkR5OWZiYTAyZDAifQ==",
     title: "Test 1",
     ...
     event_id: "eyJpZCI6MSwidG9rZW4iOiIxOHxQSDh3QThDdjZqcTNvbTVKUGo0YnNLcmhrUmZHVmdDQ0pTdDRCZkR5OWZiYTAyZDAifQ==",
     material_id: nil,
